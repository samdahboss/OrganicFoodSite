  ...
  return (
    <div>
      ...
      <form className="border-[1px] mt-12 p-6 flex flex-col gap-4 text-gray-700">
        ...
        <div className="flex">
          <label className="text-[21px]" htmlFor="rating">
            Your rating*
          </label>
        ...
        <div className="">
          <label className="text-[21px]" htmlFor="review">
            Your Review*
          </label>
          <textarea
            className="w-full h-20 border-dotted border-[1px] outline-none p-3"
            id="review"
          ></textarea>
        </div>
        ...
        <button className="w-[150px] rounded-lg bg-greenColor text-white p-3 text-sm font-semibold">
          SUBMIT
        </button>
      </form>
    </div>
